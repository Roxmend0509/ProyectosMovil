...
public class ContactsCursorAdapter extends CursorAdapter {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        //Vista poseedora para el nuevo renglon
        ViewHolder viewHolder = new ViewHolder(context, view);
        //Añade la vista
        view.setTag(viewHolder);

        //OnClickListeners para la fila and casilla de verificacion
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        //Trae la vista de el renglon
        ViewHolder viewHolder = (ViewHolder) view.getTag();
        // Edita la vista con el nuevo contacto
    ...
    public void changeCursor(Cursor cursor) {
        ...
        //Reconstruir verificador de elementos
    ...
    //Retorna verdadero si son los mismos elementos
    public boolean hasCheckedItems() {
        return checkedItems.getSize() > 0;
    }

    //Retorna lista de contactos para checar elementos
